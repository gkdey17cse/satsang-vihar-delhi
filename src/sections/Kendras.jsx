      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="text-base prose prose-lg text-[var(--text-muted)]">
              <div className="mb-6">
              ...
              <button className="bg-[var(--primary)] text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-[var(--primary-hover)] transition-colors shadow-md">
                Find a SUK Near You
              </button>
            </div>
          </div>
          ...
          <div className="bg-[var(--bg-main)] p-8 rounded-2xl shadow-lg border border-[var(--border-subtle)]">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={loc}
                  className="text-sm lg:text-base flex items-center text-[var(--text-muted)] border-b border-[var(--border-subtle)] pb-2 last:border-0"
                >
