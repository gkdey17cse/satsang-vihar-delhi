          ...
          <div>
            ...
            <div className="prose prose-lg text-[var(--text-muted)]">
              <div className="mb-6">
                ...
                <span className="block mt-2 text-sm opacity-70 not-italic">
              ...
              <button className="bg-[var(--primary)] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[var(--primary-hover)] transition-colors shadow-md">
                Find a SUK Near You
              </button>
            </div>
          </div>
