...
const Contact = () => {
  ...
  const mapEmbedUrl =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.666453669886!2d77.18241697528574!3d28.54974397571004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1df6b9b3b3b3%3A0x6b3b3b3b3b3b3b3b!2sSatsang%20Vihar%20New%20Delhi!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin";
    ...
    >
      ...
      <div className="relative z-20 w-full mx-auto px-4 sm:px-6 lg:px-8 flex justify-end">
        <div className="w-full max-w-xl bg-[var(--bg-main)] p-8 md:p-10 rounded-lg shadow-2xl border border-[var(--border-subtle)] my-12">
          <h2 className="text-xl md:text-3xl  font-bold text-[var(--text-main)] mb-8 border-b border-[var(--primary)] pb-2 uppercase tracking-wide">
            Contact Information
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[var(--bg-secondary)] p-4 rounded border border-[var(--border-subtle)]">
              ...
              <div className="text-[12px] text-[var(--text-muted)] leading-relaxed space-y-2">
                ...
                <p>
                  Alight at Adhchini Bus Stop. Board a bus heading toward
                  Katwaria Sarai.
                </p>
              </div>
            </div>
