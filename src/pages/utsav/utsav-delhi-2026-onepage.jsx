...
const carouselImages = [
  "https://res.cloudinary.com/dk3sj0t4u/image/upload/w_1280,q_auto,f_auto/v1775853716/1_tigtbw.jpg",
  "https://res.cloudinary.com/dk3sj0t4u/image/upload/w_1280,q_auto,f_auto/v1775853730/17_cra93u.jpg",
  "https://res.cloudinary.com/dk3sj0t4u/image/upload/w_1280,q_auto,f_auto/v1775853717/4_mt6fo0.jpg",
  "https://res.cloudinary.com/dk3sj0t4u/image/upload/w_1280,q_auto,f_auto/v1775853722/10_4_wccawn.jpg",
  "https://res.cloudinary.com/dk3sj0t4u/image/upload/w_1280,q_auto,f_auto/v1775853728/15_1_qvn1ji.jpg",
  "https://res.cloudinary.com/dk3sj0t4u/image/upload/w_1280,q_auto,f_auto/v1775853720/7_7_fbt9xq.jpg",
];
// The White Band image
const whiteBandImage =
  "https://res.cloudinary.com/dk3sj0t4u/image/upload/v1771797051/whiteband_jdijzp.jpg";

// Dummy Image Data for Gallery (Replace URLs with your actual image links later)
const galleryImages = [
  { id: 1, url: "https://picsum.photos/seed/utsav1/800/600", alt: "Utsav Memory 1" },
  { id: 2, url: "https://picsum.photos/seed/utsav2/800/600", alt: "Utsav Memory 2" },
  { id: 3, url: "https://picsum.photos/seed/utsav3/800/600", alt: "Utsav Memory 3" },
  { id: 4, url: "https://picsum.photos/seed/utsav4/800/600", alt: "Utsav Memory 4" },
  { id: 5, url: "https://picsum.photos/seed/utsav5/800/600", alt: "Utsav Memory 5" },
  { id: 6, url: "https://picsum.photos/seed/utsav6/800/600", alt: "Utsav Memory 6" },
  { id: 7, url: "https://picsum.photos/seed/utsav7/800/600", alt: "Utsav Memory 7" },
  { id: 8, url: "https://picsum.photos/seed/utsav8/800/600", alt: "Utsav Memory 8" },
  { id: 9, url: "https://picsum.photos/seed/utsav9/800/600", alt: "Utsav Memory 9" },
  { id: 10, url: "https://picsum.photos/seed/utsav10/800/600", alt: "Utsav Memory 10" },
  { id: 11, url: "https://picsum.photos/seed/utsav11/800/600", alt: "Utsav Memory 11" },
  { id: 12, url: "https://picsum.photos/seed/utsav12/800/600", alt: "Utsav Memory 12" },
  { id: 13, url: "https://picsum.photos/seed/utsav13/800/600", alt: "Utsav Memory 13" },
  { id: 14, url: "https://picsum.photos/seed/utsav14/800/600", alt: "Utsav Memory 14" },
  { id: 15, url: "https://picsum.photos/seed/utsav15/800/600", alt: "Utsav Memory 15" },
  { id: 16, url: "https://picsum.photos/seed/utsav16/800/600", alt: "Utsav Memory 16" },
];
...
const UtsavDelhi2026 = () => {
  ...
  const navLinks = [
    ...
    { name: "Media", to: "media" }, // Added Media to nav
    { name: "About", to: "about" },
    ...
    <>
      ...
      <div className="flex flex-col min-h-screen bg-[var(--bg-main)]">
        ...
        <main className="flex-grow">
          ...
          {/* --- NEW MEDIA & MEMORIES SECTION --- */}
          <section id="media" className="py-20 px-4 bg-[var(--bg-main)]">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-bold text-[var(--text-main)] mb-4">
                  Media & Memories
                ...
                <div className="w-24 h-1 bg-[var(--primary)] mx-auto rounded-full"></div>
                <p className="text-[var(--text-muted)] text-sm md:text-base mt-4">
                  Relive the blissful moments through our live coverage and photo gallery.
                </p>
              </div>
              ...
              <div className="mb-20">
                <h3 className="text-2xl md:text-3xl font-bold mb-8 flex items-center gap-3 text-[var(--text-main)]">
                  <PlayCircle className="text-[var(--primary)] w-8 h-8" /> 
                  Live Coverage & Special Videos
                </h3>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* Facebook Video */}
                  <div className="rounded-2xl overflow-hidden shadow-lg bg-black aspect-video flex items-center justify-center border border-[var(--border-subtle)]">
                    <iframe
                      src="https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2F100064377684857%2Fvideos%2F26277954788514211%2F&show_text=false&width=560&t=0"
                      width="100%"
                      height="100%"
                  ...
                  {/* YouTube Video 1 */}
                  <div className="rounded-2xl overflow-hidden shadow-lg bg-black aspect-video border border-[var(--border-subtle)]">
                    <iframe
                      width="100%"
                      height="100%"
                      src="https://www.youtube.com/embed/a3_GtmLRU0E?si=qdfMSnWagck1lODT"
                  ...
                  <div className="rounded-2xl overflow-hidden shadow-lg bg-black aspect-video border border-[var(--border-subtle)]">
                    <iframe
                      width="100%"
                      height="100%"
                      src="https://www.youtube.com/embed/wfsPTc3w2_w?si=mwz5COUMooHz9P0-"
                      title="YouTube video player"
                      frameBorder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      referrerPolicy="strict-origin-when-cross-origin"
              ...
              <div>
                ...
                {/* Masonry Layout for 4:3 images */}
                <div className="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
                  {displayedPhotos.map((img) => (
                    <div
                      key={img.id}
                      className="break-inside-avoid rounded-xl overflow-hidden shadow-md border border-[var(--border-subtle)] group relative"
                    >
                      <img
                        src={img.url}
                        alt={img.alt}
                ...
                {!showAllPhotos && (
                  <div className="mt-12 flex justify-center">
                    <button
                      ...
                      className="inline-flex items-center gap-2 bg-[var(--bg-secondary)] border-2 border-[var(--primary)] text-[var(--primary)] px-8 py-3.5 rounded-full font-bold hover:bg-[var(--primary)] hover:text-white transition-all duration-300 group shadow-lg"
                    >
                      Show More Photos
