  ...
  return (
    <>
      <Helmet>
        ...
        />
        {/* Your specific thumbnail for this page */}
        <meta
          property="og:image"
          ...
          >
            ...
            <div className="relative z-10 text-center px-4 max-w-7xl mx-auto">
              ...
              <p className="hidden md:block text-lg text-gray-200 mb-10 font-light max-w-3xl mx-auto leading-relaxed drop-shadow-md">
                ...
                career decisions through expert mentorship from IAS officers,
                DRDO scientists, and Global Industry Leaders.
              </p>
            ...
            <div className="max-w-7xl mx-auto px-5">
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-6 md:gap-8 mb-12 md:mb-16">
                ...
                <p className="w-full lg:w-1/2 leading-relaxed text-[var(--text-muted)] text-sm lg:text-base text-justify md:text-left lg:text-justify">
                  ...
                  Counselling Seminar. Explore highlights of keynote sessions,
                  1:1 mentorship circles, and interactive student engagements
                  designed to shape the leaders of tomorrow.
                </p>
              </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                      ...
                      <div className="text-center md:text-left">
                        ...
                        <p className="mt-6 text-sm text-[var(--text-muted)] leading-relaxed italic border-l-2 border-[var(--border-subtle)] pl-4 hidden lg:block">
                          Leading the transformation of civil service coaching
                          and public administration excellence.
                        </p>
                      </div>
            ...
            <div className="max-w-6xl mx-auto px-4">
              <div className="text-center mb-16">
                ...
                <p className="text-[var(--primary)] text-sm md:text-lg font-medium">
                  Officer Transit Facility Hall, DRDO Residential Complex,
                  (DROMI) Timarpur • 20th February 2026
                </p>
              </div>
                  ...
                  },
                  {
                    ...
                    subsections: [
                      ...
                      },
                      {
                        ...
                        content:
                          "Topic: 'Career Pathways and Strategic Choices'",
                      },
                      {
                        content:
